    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                ...
                console.log("Ocurrió un error al traer los productos");
            } finally {
                setLoading(false);
            }
        };
            ...
            <header className="bg-dark">
                ...
                {isFiltering && (
                    <header className="bg-dark py-3 text-white">
                        <h4 className="mx-30 ps-4">Resultados de la búsqueda "{searchTerm}"
                                    ...
                                    <div className="card h-100">
                                        <div className="card-body p-4">
                                            <div className="text-center">
                                                <Spinner style={{ color: 'pink' }} animation="border" role="status">
                                                </Spinner>
                                            </div>
                                        </div>
                                    </div>
